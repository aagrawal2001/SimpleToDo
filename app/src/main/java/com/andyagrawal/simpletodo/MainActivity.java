...
public class MainActivity extends AppCompatActivity {
    ...
    public void onAddItem(View view) {
        ...
        TodoItem item = new TodoItem(itemText, null);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_CODE) {
            ...
            int dueDateYear = data.getExtras().getInt("dueDateYear", 0);
            int dueDateMonth = data.getExtras().getInt("dueDateMonth", 0);
            int dueDateDay = data.getExtras().getInt("dueDateDay", 0);
            Date dueDate = new Date(dueDateYear, dueDateMonth, dueDateDay);
            items.set(pos, new TodoItem(value, dueDate));
            itemsAdapter.notifyDataSetChanged();
            writeItems();
        }
    }
    ...
    private void writeItems() {
        ...
        for (TodoItem item: items) {
            ...
            // of the function.
            TodoItem newItem = new TodoItem(item.text, item.dueDate);
